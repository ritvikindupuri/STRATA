...
function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-6">
      ...
      <Link to="/" className="absolute left-6 top-6"><LogoMark /></Link>

      <div className="relative w-full max-w-md rounded-2xl border border-border bg-card/80 p-8 card-elevated backdrop-blur">
        ...
        <form onSubmit={handleEmail} className="space-y-4">
          ...
          <div>
            ...
            <Input id="password" type="password" required minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} className="mt-1" autoComplete={mode === "signup" ? "new-password" : "current-password"} />
          </div>
